          ...
          <v-card-text>
            ...
            <v-card>
              ...
              <v-data-table
                ...
                show-select
                class="elevation-1"
                item-key="Ingredientes"
              >
            </v-data-table>
              <div class="text-right pt-2">
                <v-btn color="green" text class="mr-2"> Guardar </v-btn>
                <v-dialog v-model="dialog5" max-width="500px">
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-spacer></v-spacer>
                      <v-btn color="red" text @click="dialog5 = false">
                        Cancelar
                      </v-btn>
                      <v-btn color="green" text @click="dialog5 = false">
                        Guardar
                      </v-btn>
                    </v-card-actions>
                  </v-card>
            ...
            <v-card>
              ...
              <v-simple-table>
                <template v-slot:default>
                  ...
                  <tbody>
                    <tr v-for="item in desserts2" :key="item.Ingredientes">
                      <td></td>
...
export default class Principal extends Vue {
  ...
  @Watch("ingredients")
  onIngredientsChanged(newValue, oldValue) {
